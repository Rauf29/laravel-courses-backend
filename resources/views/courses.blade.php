                    ...
                    <form id="filter-courses" class="w-3/12 block bg-white p-4 px-6 shadow rounded-sm" method="GET">
                        ...
                        <div class="pt-6">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                ...
                                <input name="search" type="text" value="{{ array_key_exists('search', $_GET) ? $_GET ['search'] : '' }}" class="block w-full rounded border border-gray-300 bg-white py-2 pl-10 pr-3 leading-5 placeholder-gray-500 focus:border-indigo-500 focus:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm" placeholder="Enter keywords">
                            </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="pt-6">
                            ...
                            <div class="flex items-center">
                                <input name="level"
                                @if(array_key_exists('level', $_GET) && $_GET['level']==='beginner') checked @endif id="filter-level-beginner" value="beginner" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 form-submit">
                                <label for="filter-level-beginner" class="ml-3 text-sm text-gray-600  "> Beginner <span class="text-xs text-gray-500">(10)</span>
                                </label>
                            </div>
                            <div class="flex items-center">
                                <input name="level"
                                @if(array_key_exists('level', $_GET) && $_GET['level']==='intermediate') checked @endif   id="filter-level-intermediate" value="intermediate" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 form-submit">
                            ...
                            <div class="flex items-center">
                                <input name="level"
                                @if(array_key_exists('level', $_GET) && $_GET['level']==='advanced') checked @endif id="filter-level-advanced" value="advanced" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 form-submit">
