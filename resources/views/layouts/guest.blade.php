    ...
    <body>
                    ...
                    <div class="flex items-center">
                        @if (Auth::check())
                            ...
                            <form class=" ml-4" method="POST" action="{{ route('logout') }}"> @csrf
                                <button class=" text-red-600 " type="submit">Log-out</button>
                            </form>
                        @else
                            <a href="{{ route('login') }}"
        ...
        <footer class="w-full bg-dark pt-[94px] relative">
            <img src="{{ asset('build/img/footer-cure.png') }}" alt="Stylish Design"
            ...
            <div class="container flex justify-between pb-[50px]">
                ...
                <div>
                    ...
                    <ul class="mt-5">
                        <li class="mb-2">
                            <a href="{{ route('archive',['duration','1-2-hours']) }}" class="text-links text-gray-100 text-base before:text-gray-100">1-5
                                hours</a>
                        </li>
                        <li class="mb-2">
                ...
                <div>
                    ...
                    <ul class="mt-5">
                        ...
                        <li class="mb-2">
                            <a href="{{ route('archive',['platform','Laravel-Daily']) }}" class="text-links text-gray-100 text-base before:text-gray-100">Laravel
                                Daily</a>
                        </li>
                        <li class="mb-2">
                ...
                <div>
                    <h2 class="text-lg-primary-2 text-white">Course by Topic</h2>
                    <ul class="mt-5">
                        <li class="mb-2">
            ...
            <div class="mx-auto container flex items-center justify-between gap-5 pb-8">
                ...
                <p class="text-sm  text-center text-[#E5E5E580] leading-5 z-50 relative"> Developed by <a
                        ...
                        class="hover:underline font-medium">Mohammad Emran ⚡️</a></p>
                <span></span>
            </div>
        </footer>
    </body>
